...
add wave -noupdate -expand -group SENT-0 -radix unsigned {/tb_sent/u_sent_top/genblk1[0]/u_sent_ctrl/sent_frame_crc}
add wave -noupdate -expand -group SENT-0 {/tb_sent/u_sent_top/genblk1[0]/u_sent_ctrl/sent_fifo_rden}
...
add wave -noupdate -expand -group SENT-1 -radix unsigned {/tb_sent/u_sent_top/genblk1[1]/u_sent_ctrl/sent_frame_crc}
add wave -noupdate -expand -group SENT-1 {/tb_sent/u_sent_top/genblk1[1]/u_sent_ctrl/sent_fifo_rden}
